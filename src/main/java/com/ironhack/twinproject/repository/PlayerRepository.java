...
public interface PlayerRepository extends JpaRepository<Player, Long> {
    ...
    List<String> listPlayersByScore();
    ...
    List<String> listPlayersByScoreInHistory();
    ...
    List<String> listPlayersByScoreInMusic();
    ...
    List<String> listPlayersByScoreInOlympics();
    ...
    List<String> listPlayersByScoreInUSCities();

    @Query(value = "SELECT p.name, t.cars_points FROM player p INNER JOIN points t on p.points_id = t.id ORDER BY t.cars_points desc", nativeQuery = true)
    List<String> listPlayersByScoreInCars();
